...
LT(_FN, KC_TAB), KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_LBRC, KC_RBRC, LT(_FN, KC_BSLS),
        ...
        KC_LCTL, KC_LGUI, KC_LALT,                            LT(_SP, KC_SPC),           LT(_WH, KC_RALT), MO(_FN), KC_APP,  KC_RCTL
    ),
    [_GM] = LAYOUT_60_ansi(
    ...
    [_FN] = LAYOUT_60_ansi(
        ...
        KC_CAPS, 0x5d61,  _______,                            KC_BTN1,                            _______, _______, _______, _______
    ),
    [_WH] = LAYOUT_60_ansi(
